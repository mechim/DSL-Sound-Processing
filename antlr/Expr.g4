...
method_invocation: method_name '('method_atributes')';
method_atributes: (INT|CHR|STRING)*? | method_atributes ',' method_atributes | '-' method_atributes;
method_name: 'load' | 'delay' | 'setreverb' | 'setgain' | 'changepitch' |'fadein' | 'fadeout' | 'play' | 'splice' | 'repeat' | 'layer' | 'cut';
