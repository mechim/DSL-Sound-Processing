...
class ExprListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ExprParser#method_atributes.
    def enterMethod_atributes(self, ctx:ExprParser.Method_atributesContext):
        pass

    # Exit a parse tree produced by ExprParser#method_atributes.
    def exitMethod_atributes(self, ctx:ExprParser.Method_atributesContext):
        pass
